...
\begin{abstract}
We propose a novel method for enhancing classification performance of ACM papers from citation network dataset by linking the categories to Wikipedia articles using Learning to Rank method. We empherically demonstrate that our method which uses recent representation learning methods for document represention outperforms state-of-the-art method for text classification.
