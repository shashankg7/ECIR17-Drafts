...
\title{Using Learning to Rank to enhance Document Classification}
...
\begin{abstract}
We propose a Learning to Rank framework for enhancing categorization of research articles by combining semantic representation of research articles and Wikipedia page of the categories. We empherically show that adding semantic information of the wikipedia articles  enhances the classification performance of the articles as compared to state-of-the-art document classification methods.
